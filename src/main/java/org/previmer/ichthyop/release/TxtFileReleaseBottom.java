...
/**
 *
 * @author pverley modified lmengel422
 */
public class TxtFileReleaseBottom extends AbstractRelease {
    ...
    public void loadParameters() throws IOException {
        ...
        textFile = getFile(getParameter("txtfilebottom"));
        ...
        while ((line = bfIn.readLine()) != null) {
            if (!line.startsWith("#") & !(line.length() < 1)) {
                ...
                double depth = Double.NaN;
                    ...
                    depth = getSimulationManager().getDataset().getBathyPos(coord[0], coord[1])*0.5;
